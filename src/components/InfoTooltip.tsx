...
export const InfoTooltip = ({ text }: Props) => (
  <span className='relative group inline-flex shrink-0'>
    ...
    <span className='absolute left-0 bottom-full mb-1.5 w-max max-w-xs bg-gray-800 text-white text-xs rounded-lg p-2.5 hidden group-hover:block z-10 leading-relaxed shadow-lg'>
      {text}
    </span>
  </span>
);
